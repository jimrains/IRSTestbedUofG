// IRS configuration program for 3-bit IRS
// Compile on Raspberry Pi using: g++ IRSconfig.cpp -o IRSconfig -lwiringPi

// Connects via socket to PC ->
// Sends acknowledgement to PC to ask for more data ->
// Translates data into correct format ->
// Sends 576 bits to FPGA to program IRS ->
// Awaits FPGA feedback 'done' signal ->
// Sends acknowledgement to PC and repeats from step 3
...
// Bit mapping - maps serial stream to correct shift register outputs
...
// Plotting function (still to implement)
