...
ref = load(strcat(sweep_dir,'20211016_23950_SWEEP_3900_IRSoff.dat'))
%nors = load(strcat(sweep_dir,'2021106_212323_SWEEP_1A.dat'))
%nors = load(strcat(sweep_dir,'2021106_23516_SWEEP_1B.dat'))

d1bit = load(strcat(sweep_dir,'20211016_232633_SWEEP_3900_1bitOpt.dat'))
d2bit = load(strcat(sweep_dir,'20211016_23191_SWEEP_3900_2bitOpt.dat'))
d3bit = load(strcat(sweep_dir,'20211016_23534_SWEEP_3900_3bitOpt.dat'))
